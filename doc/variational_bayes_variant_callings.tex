...
\begin{align}
\label{eq:sph_pp}
     p(h_i \; \text{occurs in samples}| \boldsymbol{X}, \boldsymbol{\alpha}) &= 1 - p(h_i \; \text{does not occur in samples}| \boldsymbol{X}, \boldsymbol{\alpha}) \notag \\
     &= 1 - \sum_{\boldsymbol{g} \; \text{s.t.} \; \mu_i(\boldsymbol{g}) = 0} p(\boldsymbol{g} | \boldsymbol{X}, \boldsymbol{\alpha}) \notag \\
     &= 1 -  \sum_{\boldsymbol{g} \; \text{s.t.} \; \mu_i(\boldsymbol{g}) = 0} \frac{M!}{\prod_{i = 1}^{H} \mu_i(\boldsymbol{g}^k)} \frac{\Gamma(\alpha_0)}{\Gamma(M + \alpha_0)} \prod_{i = 1}^H \frac{\Gamma(\mu_i(\boldsymbol{g}^k) + \alpha_i)}{\Gamma(\alpha_i)}
\end{align}
...
\begin{align}
\label{eq:sh_pp}
p(h_i \; \text{occurs in sample } n | \boldsymbol{X}, \boldsymbol{\alpha}) &= 1 - p(h_i \; \text{does not occur in sample } n | \boldsymbol{X}, \boldsymbol{\alpha}) \notag \\
    &= 1 - \sum_{k \; \text{s.t.} \; \mu_i(\boldsymbol{g}^k) = 0} \tau_{nk}
\end{align}
...
\begin{align}
\label{eq:spa_pp}
    p(a \text{ occurs in samples}| \boldsymbol{X}, \boldsymbol{\alpha}) &= \sum_{i = 1}^H p(a \in h_i) p(h_i \; \text{occurs in samples}| \boldsymbol{X}, \boldsymbol{\alpha}) \notag \\
    &= \sum_{i = 1}^H [a \in h_i] \left\{ 1 -  \sum_{\boldsymbol{g} \; \text{s.t.} \; \mu_i(\boldsymbol{g}) = 0} \frac{M!}{\prod_{i = 1}^{H} \mu_i(\boldsymbol{g}^k)} \frac{\Gamma(\alpha_0)}{\Gamma(M + \alpha_0)} \prod_{i = 1}^H \frac{\Gamma(\mu_i(\boldsymbol{g}^k) + \alpha_i)}{\Gamma(\alpha_i)} \right\}
\end{align}
...
\begin{align}
\label{eq:sa_pp}
    p(a \text{ occurs in sample } n | \boldsymbol{X}, \boldsymbol{\alpha}) &=  \sum_{i = 1}^H p(a_n \in h_i) p(h_i \; \text{occurs in sample } n | \boldsymbol{X}, \boldsymbol{\alpha}) \notag \\
    &= \sum_{i = 1}^H [a_n \in h_i] \left\{ 1 - \sum_{k \; \text{s.t.} \; \mu_i(\boldsymbol{g}^k) = 0} \tau_{nk} \right\}
\end{align}
