...
TEST_CASE("haploid_genotype_model_test", "[genotype_model]")
{
    ...
    GenotypeModel the_model {ploidy};
    ...
    haplotype_log_probabilities[haplotypes[0]] = -1.386294;
    haplotype_log_probabilities[haplotypes[1]] = -1.386294;
    haplotype_log_probabilities[haplotypes[2]] = -1.386294;
    haplotype_log_probabilities[haplotypes[3]] = -1.386294;
