...
TEST_CASE("diploid_empirical_variational_bayes_genotype_model", "[empirical_variational_bayes_genotype_model]")
{
    ...
    auto ref_posterior_count = the_model.posterior_haplotype_pseudo_count(reference_haplotype,
                                                                          pseudo_counts[reference_haplotype],
                                                                          { responsabilities });
    auto hap1_posterior_count = the_model.posterior_haplotype_pseudo_count(hap1, pseudo_counts[hap1],
                                                                          { responsabilities });
    auto hap2_posterior_count = the_model.posterior_haplotype_pseudo_count(hap2, pseudo_counts[hap2],
                                                                          { responsabilities });
