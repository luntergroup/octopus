...
BOOST_AUTO_TEST_CASE(indels_can_be_left_aligned)
{
    ...
    GenomicRegion region {"4", 657, 660}; // sequence around region is CCAGCAGCAGCAGCAG...
    ...
    BOOST_CHECK_EQUAL(left_aligned_deletion.mapped_region(), (GenomicRegion {"4", 603, 606}));
    BOOST_CHECK_EQUAL(ref_sequence(left_aligned_deletion), "CAG");
    BOOST_CHECK_EQUAL(alt_sequence(left_aligned_deletion), "");
    
    Variant raw_insertion {GenomicRegion {"4", 660, 660}, "", sequence};
    
    auto left_aligned_insertion = left_align(raw_insertion, reference);
    
    BOOST_CHECK_EQUAL(left_aligned_insertion.mapped_region(), (GenomicRegion {"4", 603, 603}));
    BOOST_CHECK_EQUAL(ref_sequence(left_aligned_insertion), "");
    BOOST_CHECK_EQUAL(alt_sequence(left_aligned_insertion), "CAG");
    
    region = GenomicRegion {"5", 956, 959}; // sequence around region is CCAACAACAACAACAC
    ...
    BOOST_CHECK_EQUAL(left_aligned_deletion.mapped_region(), (GenomicRegion {"5", 949, 952}));
    BOOST_CHECK_EQUAL(ref_sequence(left_aligned_deletion), "ACA");
    BOOST_CHECK_EQUAL(alt_sequence(left_aligned_deletion), "");
    
    raw_insertion = Variant {GenomicRegion {"5", 959, 959}, "", sequence};
    
    left_aligned_insertion = left_align(raw_insertion, reference);
    
    BOOST_CHECK_EQUAL(left_aligned_insertion.mapped_region(), (GenomicRegion {"5", 949, 949}));
    BOOST_CHECK_EQUAL(ref_sequence(left_aligned_insertion), "");
...
BOOST_AUTO_TEST_CASE(can_make_variants_parsimonious)
{
    ...
    Variant raw_snp {GenomicRegion {"6", 330, 331}, std::string {"G"}, std::string {"C"}};
    
    BOOST_CHECK(is_parsimonious(raw_snp));
    BOOST_CHECK_EQUAL(make_parsimonious(raw_snp, reference), raw_snp);
    
    Variant unparsimonious_snp {GenomicRegion {"6", 330, 332}, std::string {"GT"}, std::string {"CT"}};
    ...
    Variant another_unparsimonious_snp {GenomicRegion {"6", 329, 332}, std::string {"TGT"}, std::string {"TCT"}};
    ...
    auto region = GenomicRegion {"6", 330, 335};
    ...
    Variant unparsimonious_insertion {GenomicRegion {"6", 329, 331}, "CG", "CGTGGA"};
...
BOOST_AUTO_TEST_CASE(can_normalise_variants)
{
   const auto reference = mock::make_reference();
    ...
    Variant raw_snp {GenomicRegion {"4", 657, 658}, std::string {"G"}, std::string {"C"}};
    ...
    auto region = GenomicRegion {"4", 657, 660};
    ...
    BOOST_CHECK_EQUAL(normilised_deletion.mapped_region(), (GenomicRegion {"4", 602, 606}));
    ...
    BOOST_CHECK_EQUAL(normilised_insertion.mapped_region(), (GenomicRegion {"4", 602, 603}));
    BOOST_CHECK_EQUAL(ref_sequence(normilised_insertion), "C");
    BOOST_CHECK_EQUAL(alt_sequence(normilised_insertion), "CCAG");
    
    // Some hard ones
    
    Variant unormilised_snp {GenomicRegion {"4", 656, 659}, std::string {"AGC"}, std::string {"ACC"}};
    ...
    BOOST_CHECK_EQUAL(normalised_snp.mapped_region(), (GenomicRegion {"4", 657, 658}));
    BOOST_CHECK_EQUAL(ref_sequence(normalised_snp), "G");
    BOOST_CHECK_EQUAL(alt_sequence(normalised_snp), "C");
    
    Variant unormilised_mnp {GenomicRegion {"4", 656, 661}, std::string {"GCAGC"}, std::string {"GGACC"}};
    ...
    BOOST_CHECK(is_parsimonious(normalised_mnp));
    BOOST_CHECK_EQUAL(normalised_mnp.mapped_region(), (GenomicRegion {"4", 657, 660}));
    BOOST_CHECK_EQUAL(ref_sequence(normalised_mnp), "CAG");
    BOOST_CHECK_EQUAL(alt_sequence(normalised_mnp), "GAC");
    
    Variant unnormilised_deletion {GenomicRegion {"4", 655, 660}, std::string {"AGCAG"}, std::string {"AG"}};
    ...
    BOOST_CHECK_EQUAL(normalised_deletion.mapped_region(), (GenomicRegion {"4", 602, 606}));
    BOOST_CHECK_EQUAL(ref_sequence(normalised_deletion), "CCAG");
    BOOST_CHECK_EQUAL(alt_sequence(normalised_deletion), "C");
    
    Variant unnormilised_insertion {GenomicRegion {"4", 655, 657}, std::string {"AG"}, std::string {"AGCAG"}};
    ...
    BOOST_CHECK_EQUAL(normalised_insertion.mapped_region(), (GenomicRegion {"4", 602, 603}));
