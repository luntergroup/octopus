...
BOOST_AUTO_TEST_CASE(comparing_order_of_regions_on_different_contigs_is_an_error)
{
    ...
    BOOST_CHECK_NO_THROW(r1 != r2);
    BOOST_CHECK_THROW(r1 <= r2, BadRegionCompare);
    BOOST_CHECK_THROW(r1 < r2, BadRegionCompare);
    BOOST_CHECK_THROW(r1 > r2, BadRegionCompare);
    BOOST_CHECK_THROW(r1 >= r2, BadRegionCompare);
    BOOST_CHECK_THROW(is_before(r1, r2), BadRegionCompare);
    BOOST_CHECK_THROW(is_after(r1, r2), BadRegionCompare);
    BOOST_CHECK_THROW(begins_before(r1, r2), BadRegionCompare);
    BOOST_CHECK_THROW(ends_before(r1, r2), BadRegionCompare);
}
