...
//    ReadModel a_read_model {ploidy};
//    
//    Genotype hom_ref {}; hom_ref.emplace(reference_haplotype); hom_ref.emplace(reference_haplotype);
//    Genotype het_alt {}; het_alt.emplace(reference_haplotype); het_alt.emplace(true_haplotype);
//    Genotype hom_alt {}; hom_alt.emplace(true_haplotype); hom_alt.emplace(true_haplotype);
//    
//    auto genotypes = get_all_genotypes(haplotypes, ploidy);
...
TEST_CASE("haplotype priors affect genotype calls when support is low", "variational_bayes_genotype_model")
{
    ...
    ReadManager a_read_manager {std::vector<std::string> {human_1000g_bam1, human_1000g_bam0, human_1000g_bam2, human_1000g_bam3}};
    ...
    Genotype ref_ref {};       ref_ref.emplace(reference_haplotype); ref_ref.emplace(reference_haplotype);
    Genotype ref_true {};      ref_true.emplace(reference_haplotype); ref_true.emplace(true_haplotype);
    Genotype ref_false1 {};    ref_false1.emplace(reference_haplotype); ref_false1.emplace(false_haplotype1);
    Genotype ref_false2 {};    ref_false2.emplace(reference_haplotype); ref_false2.emplace(false_haplotype2);
    Genotype ref_false3 {};    ref_false3.emplace(reference_haplotype); ref_false3.emplace(false_haplotype3);
    Genotype true_true {};     true_true.emplace(true_haplotype); true_true.emplace(true_haplotype);
    Genotype true_false1 {};   true_false1.emplace(true_haplotype); true_false1.emplace(false_haplotype2);
    Genotype true_false2 {};   true_false2.emplace(true_haplotype); true_false2.emplace(false_haplotype2);
    Genotype true_false3 {};   true_false3.emplace(true_haplotype); true_false3.emplace(false_haplotype3);
    Genotype true_false4 {};   true_false4.emplace(true_haplotype); true_false4.emplace(false_haplotype4);
    Genotype false1_false1 {}; false1_false1.emplace(false_haplotype1); false1_false1.emplace(false_haplotype1);
    Genotype false1_false2 {}; false1_false2.emplace(false_haplotype1); false1_false2.emplace(false_haplotype2);
    Genotype false1_false3 {}; false1_false3.emplace(false_haplotype1); false1_false3.emplace(false_haplotype3);
    Genotype false2_false2 {}; false2_false2.emplace(false_haplotype2); false2_false2.emplace(false_haplotype2);
    Genotype false2_false3 {}; false2_false3.emplace(false_haplotype2); false2_false3.emplace(false_haplotype3);
    Genotype false3_false3 {}; false3_false3.emplace(false_haplotype3); false3_false3.emplace(false_haplotype3);
