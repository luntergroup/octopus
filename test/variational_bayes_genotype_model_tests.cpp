...
//    
//    BOOST_CHECK(is_close_to_one(haplotype_posterior_sum));
//}
//
//BOOST_AUTO_TEST_CASE(genotype posteriors sum to one)
//{
//    ReferenceGenomeFactory a_factory {};
//    ReferenceGenome human {a_factory.make(human_reference_fasta)};
//    
...
//    }
//    
//    BOOST_CHECK(is_close_to_one(genotype_posterior_sum));
//    
//    ploidy = 2;
...
//}
//
//BOOST_AUTO_TEST_CASE(what happens when two heterzygous genotypes are equally likely)
//{
//    cout.precision(10);
//    
//    ReferenceGenomeFactory a_factory {};
...
//}
//
//BOOST_AUTO_TEST_CASE(what happens when a unlikely haplotype has a large liklihood)
//{
//    cout.precision(10);
//    
//    ReferenceGenomeFactory a_factory {};
