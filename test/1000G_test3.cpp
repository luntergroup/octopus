...
//BOOST_AUTO_TEST_CASE(1000G test 3: 2:104142870-104142884)
//{
//    unsigned ploidy {2};
//
...
//
//    auto a_region = parse_region("2:104142854-104142945", human);
//
...
//    true_haplotype.push_back(Allele {parse_region("2:104142874-104142874", human), "AGG"});
//    true_haplotype.push_back(Allele {parse_region("2:104142879-104142880", human), "A"});
//
//    Haplotype false_haplotype1 {human, a_region};
//    false_haplotype1.push_back(Allele {parse_region("2:104142877-104142878", human), "G"});
//
//    Haplotype false_haplotype2 {human, a_region};
//    false_haplotype2.push_back(Allele {parse_region("2:104142874-104142874", human), "AGG"});
//    false_haplotype2.push_back(Allele {parse_region("2:104142877-104142878", human), "G"});
//    false_haplotype2.push_back(Allele {parse_region("2:104142879-104142880", human), "A"});
//    
...
//        cout << "ref,false1  = " << a_read_model.log_probability(sample_reads.second.cbegin(), sample_reads.second.cend(), ref_false1, sample_reads.first) << endl;
...
//        cout << "true,false1 = " << a_read_model.log_probability(sample_reads.second.cbegin(), sample_reads.second.cend(), true_false1, sample_reads.first) << endl;
