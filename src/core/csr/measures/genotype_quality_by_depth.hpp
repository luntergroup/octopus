...
#ifndef genotype_quality_by_depth_hpp
#define genotype_quality_by_depth_hpp
...
class GenotypeQualityByDepth : public Measure
{
...
public:
    GenotypeQualityByDepth(bool recalculate = false);
};
