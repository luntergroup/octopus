...
#ifndef posterior_probability_by_depth_hpp
#define posterior_probability_by_depth_hpp
...
class PosteriorProbabilityByDepth : public Measure
{
...
public:
    PosteriorProbabilityByDepth(bool recalculate = false);
};
