...
static const auto default_measure_names = utils::split("AC AD AF ARF BQ CC CRF DP FRF GC GQ GQD NC MC MF MP MQ MQ0 MQD PP PPD QD QUAL REFCALL RPB SB SD SHC SMQ SOMATIC STR_LENGTH STR_PERIOD", ' ');
