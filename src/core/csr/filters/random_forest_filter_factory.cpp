...
static const auto default_measure_names = utils::split("AC AD AF ARF BQ CC CRF DP FRF GC GQ GQD NC MC MF MP MRC MQ MQ0 MQD PP PPD QD QUAL REFCALL REB RPB RTB SB SD SF SHC SMQ SOMATIC STR_LENGTH STR_PERIOD", ' ');
