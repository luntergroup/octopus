...
constexpr decltype(UmiSnvErrorModel::maxQualities_) UmiSnvErrorModel::maxQualities_;

std::unique_ptr<SnvErrorModel> UmiSnvErrorModel::do_clone() const
{
    return std::make_unique<UmiSnvErrorModel>(*this);
}
...
void UmiSnvErrorModel::do_evaluate(const Haplotype& haplotype,
