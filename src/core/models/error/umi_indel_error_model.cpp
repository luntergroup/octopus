...
constexpr decltype(UmiIndelErrorModel::homopolymerErrors_) UmiIndelErrorModel::homopolymerErrors_;
constexpr decltype(UmiIndelErrorModel::homopolymerErrors_) UmiIndelErrorModel::diNucleotideTandemRepeatErrors_;
constexpr decltype(UmiIndelErrorModel::homopolymerErrors_) UmiIndelErrorModel::triNucleotideTandemRepeatErrors_;
constexpr decltype(UmiIndelErrorModel::homopolymerErrors_) UmiIndelErrorModel::polyNucleotideTandemRepeatErrors_;
constexpr decltype(UmiIndelErrorModel::defaultGapExtension_) UmiIndelErrorModel::defaultGapExtension_;

std::unique_ptr<IndelErrorModel> UmiIndelErrorModel::do_clone() const
{
    return std::make_unique<UmiIndelErrorModel>(*this);
}
...
UmiIndelErrorModel::PenaltyType
UmiIndelErrorModel::do_evaluate(const Haplotype& haplotype, PenaltyVector& gap_open_penalities) const
{
