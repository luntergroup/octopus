...
bool GenomeCallingComponents::annotate_filter_output() const noexcept
{
    return components_.annotate_filter_output_;
}
...
, annotate_filter_output_ {options::annotate_filter_output(options)}
{
