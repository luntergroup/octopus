...
namespace Octopus {
    ...
    public:
        ...
        void set_refcall_type(VariantCaller::RefCallType refcall_type);
        void set_min_variant_posterior(double min_posterior);
        void set_min_refcall_posterior(double min_posterior);
        
        // cancer
        void set_normal_sample(SampleIdType normal_sample);
        void set_min_somatic_posterior(double min_posterior);
        void set_somatic_only_calls();
        void set_somatic_and_variant_calls();
        void set_somatic_and_variant_and_refcalls_calls();
