...
#ifndef Octopus_composer__
#define Octopus_composer__
...
namespace octopus { namespace core { namespace generators
{
    ...
    {
    public:
        virtual ~CandidateVariantGenerator() = default;
    ...
    template <typename Container, typename G,
              typename = std::enable_if_t<std::is_base_of<CandidateVariantGenerator, G>::value>>
