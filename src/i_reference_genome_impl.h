//
//  i_reference_genome_implementor.h
//  Octopus
//
...
#ifndef Octopus_i_reference_genome_impl_h
#define Octopus_i_reference_genome_impl_h
...
public:
    ...
    virtual std::string get_reference_name() const = 0;
